<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
        {{ __('Es necesario confirmar tu cuenta antes de poder ingresar, revisa tu correo y presiona sobre el botón de verificación') }}
    </div>

    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 font-medium text-sm text-green-600 dark:text-green-400">
            {{ __('Hemos enviado un mensaje de confirmación al correo que proporcinaste en tu registro') }}
        </div>
    @endif
